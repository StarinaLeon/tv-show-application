...
import {getCurrentPageShows} from '../../../store/shows/selectors';
import {ChangeSorting, SelectGenre} from '../../../store/shows/actions';

@Component({
	selector: 'app-data-table-container',
	template:
		'<app-data-table  [shows]="shows$ | async" (genreSelected)="onChangeSelectedGenre($event)" (sortChange)="onSortChange($event)"></app-data-table>'
})
